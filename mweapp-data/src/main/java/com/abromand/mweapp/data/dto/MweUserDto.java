...
public class MweUserDto {
  ...
  public MweUserDto(Long id, String username, String password, String email, boolean cto, boolean csb, String description, String address, String phone, int ssbcount) {
    this.id = id;
